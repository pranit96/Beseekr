...
export default function FloatingAITutor() {
    ...
    const [selectedSubject, setSelectedSubject] = useState<'quant' | 'varc' | 'dilr'>('quant');
                    ...
                    >
                        ...
                        <div className="px-4 py-2 border-b border-border/50">
                            ...
                            >
                                ...
                                <ChevronDown className={cn("h-4 w-4 transition-transform", showSubjectSelector && "rotate-180")} />
                            </button>
                            <AnimatePresence>
                                {showSubjectSelector && (
                                    <motion.div
                            ...
                            {messages.length === 0 ? (
                                <div className="h-full flex flex-col items-center justify-center text-center px-6">
                                    ...
                                    <p className="text-sm text-muted-foreground mb-6">
                                        Ask me about concepts, solve doubts, or get explanations for any CAT topic.
                                    </p>
