    ...
    <div className="prose prose-sm dark:prose-invert max-w-none">
      <ReactMarkdown
        ...
        components={{
          ...
          blockquote: ({ children }) => (
            <blockquote className="border-l-4 border-primary/60 pl-4 italic text-muted-foreground my-3">
              {children}
            </blockquote>
          ),
          ...
          code({
            ...
            const detectedLang = language || (looksLikeJSON ? 'json' : looksLikeHTML ? 'html' : 'text');
