...
import { Settings as SettingsIcon, Save, User, Shield, Bell, DollarSign } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-400 mt-1">Configure your trading preferences</p>
      </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="text-xs text-slate-500 mt-1">
              Trading will be restricted if portfolio drawdown exceeds this limit
            </div>
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => setSettings({ ...settings, defaultRiskPercent: Number(e.target.value) })}
              className="w-full px-4 py-2 bg-slate-800 text-white rounded-lg border border-slate-700 focus:border-blue-500 focus:outline-none"
            />
          </div>
        </div>
        ...
        <div className="space-y-3">
          ...
          <label className="flex items-center justify-between">
            ...
            <input
              ...
              onChange={(e) => setSettings({ ...settings, exitAlerts: e.target.checked })}
              className="w-5 h-5 rounded bg-slate-800 border-slate-700"
            />
          </label>
          <label className="flex items-center justify-between">
        ...
        <div className="space-y-4">
          ...
          <label className="flex items-center justify-between">
            <div>
              ...
              <div className="text-xs text-slate-500">Automatically execute signals (Paper Trading only)</div>
            </div>
            <input
              type="checkbox"
