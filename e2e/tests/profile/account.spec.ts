...
test.describe('Profile Page', () => {
    ...
    test.describe('Authenticated User', () => {
        ...
        test.skip(({ browserName }) => !process.env.TEST_USER_EMAIL, 'Requires TEST_USER_EMAIL env var');
...
test.describe('Notification Settings', () => {
    test.skip(({ browserName }) => !process.env.TEST_USER_EMAIL, 'Requires authentication');
