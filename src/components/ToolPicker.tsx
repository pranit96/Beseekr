...
const TOOL_COLORS: Record<string, string> = {
  ...
  summarize_text:
    "from-sky-500/20 to-sky-600/10 border-sky-500/30 hover:border-sky-400/50",
  translate_text:
    "from-rose-500/20 to-rose-600/10 border-rose-500/30 hover:border-rose-400/50",
};
  ...
  return (
    <div className="space-y-2">
      ...
      <p className="text-xs text-muted-foreground">
        Enable tools to let this agent perform real actions — search the web,
        send emails, create documents, analyze data, and more.
      </p>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
        {tools.map((tool) => {
          ...
          const colorClass =
            ...
            "from-gray-500/20 to-gray-600/10 border-gray-500/30 hover:border-gray-400/50";
