...
export const DesignTokensViewer: React.FC<DesignTokensViewerProps> = ({
  tokens,
}) => {
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-3">
          {Object.entries(colors).map(([key, hexVal]) => {
            const cleanHex = String(hexVal).startsWith("#")
              ? String(hexVal)
              : `#${hexVal}`;
            ...
            return (
              <button
                ...
                onMouseLeave={(e) => {
                  ...
                  (e.currentTarget as HTMLElement).style.borderColor = isCopied
                    ? "rgba(16,185,129,0.4)"
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          {[
            ...
            {
              label: "Monospace",
              value: typography.mono_font || "Courier",
              scale: "tokens, code, specs",
            },
          ].map((item, idx) => (
            <div
              key={idx}
