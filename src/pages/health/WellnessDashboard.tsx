...
export default function WellnessDashboard() {
  ...
  const handleCameraCapture = async (
    ...
    try {
      ...
      toast({
        ...
        description: "AI is estimating calories and macros.",
      });
  ...
  const weightSparkline = (() => {
    ...
    const pts = wt.map((w, i) => ({
      x: i * step,
      y: 100 - ((w.weight_kg - mn) / rng) * 100,
    }));
    const line = pts
    ...
    return {
      line,
      fill,
      first: wt[0].weight_kg,
      last: wt[wt.length - 1].weight_kg,
    };
  })();
    ...
    <>
      ...
      <div className="wd">
        ...
        <main className="wd-main">
          ...
          <div className="card fu">
            ...
            {!data?.profile && (
              <div
                style={{
                  background:
                    "linear-gradient(90deg,rgba(62,207,110,.1),rgba(62,207,110,.02))",
                  borderBottom: "1px solid rgba(62,207,110,.14)",
                  padding: "9px 18px",
                  display: "flex",
                  alignItems: "center",
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 7 }}>
                  ...
                  <p style={{ fontSize: 11, color: "var(--t2)" }}>
                    Complete your profile to unlock your personalised AI plan
                  </p>
                </div>
                <button
                  ...
                  <div style={{ display: "flex", gap: 16, marginTop: 12 }}>
                    ...
                    <p style={{ fontSize: 10, color: "var(--t3)" }}>
                      ...
                      <span style={{ color: "var(--green)", fontWeight: 600 }}>
                        {Math.max(
                          0,
                          targets.calories - Math.round(today?.calories ?? 0),
                        ).toLocaleString()}{" "}
                        kcal
                      </span>
                    </p>
          ...
          {/* ═══ 2. VITALS GRID ══════════════════════════════════════ */}
          <div className="fu d1">
            <p className="slbl" style={{ marginBottom: 10, paddingLeft: 2 }}>
              Today's vitals
            </p>
            <div className="vitals-grid">
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Smile size={13} color="var(--violet)" />
                    </div>
                    <span
                      style={{
                        fontSize: 10,
                ...
                {isLoading ? (
                  <div
                    className="skel"
                    style={{ width: 54, height: 26, marginTop: 9 }}
                  />
                ) : (
                  <p
                    className="vnum"
                    style={{
                      color: data?.todayMood ? "var(--t1)" : "var(--t3)",
                    }}
                  >
                ...
                <p style={{ fontSize: 10, color: "var(--t3)" }}>
                  {data?.todayMood
                    ? `E ${data.todayMood.energy_level ?? "–"} · S ${data.todayMood.stress_level ?? "–"}`
                    : "Tap to log"}
                </p>
              </div>
              ...
              >
                ...
                {isLoading ? (
                  ...
                  <p
                    className="vnum"
                    style={{
                      color: data?.todaySleep ? "var(--t1)" : "var(--t3)",
                    }}
                  >
                    {data?.todaySleep
                      ? `${Number(data.todaySleep.duration_hours ?? 0).toFixed(1)}h`
                      : "–"}
                  </p>
                )}
                <p style={{ fontSize: 10, color: "var(--t3)" }}>
                  {data?.todaySleep
                    ? `Quality: ${"★".repeat(data.todaySleep.quality ?? 0)}${"☆".repeat(Math.max(0, 5 - (data.todaySleep.quality ?? 0)))}`
                    : "Tap to log"}
                </p>
              </div>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Dumbbell size={13} color="var(--teal)" />
                    </div>
                    <span
                      style={{
                        fontSize: 10,
                ...
                <p style={{ fontSize: 10, color: "var(--t3)" }}>
                  {data?.aggregates?.workouts ?? 0} sessions this week
                </p>
              </div>
              ...
              >
                ...
                {isLoading ? (
                  <div
                    className="skel"
                    style={{ width: 64, height: 26, marginTop: 9 }}
                  />
                ) : (
                  <p
                    className="vnum"
                    style={{
                      color: data?.latestWeight ? "var(--t1)" : "var(--t3)",
                    }}
                  >
                    {data?.latestWeight ? (
                      <>
              ...
              >
                ...
                {isLoading ? (
                  <div
                    className="skel"
                    style={{ width: 38, height: 26, marginTop: 9 }}
                  />
                ) : (
                  <p
                    className="vnum"
                ...
                <p style={{ fontSize: 10, color: "var(--t3)" }}>
                  {data?.aggregates?.habit_logs ?? 0} completed this week
                </p>
              </div>
                ...
                style={
                  {
                    "--ac": "var(--green)",
                    background:
                      "linear-gradient(135deg,rgba(62,207,110,.07),var(--s2))",
                  } as any
                }
                onClick={() =>
                  navigate(
                    data?.profile ? "/wellness/plan" : "/wellness/onboarding",
                  )
                }
              >
                <div
            ...
            <div className="fu d3">
              ...
              <div className="streak-row">
                {[
                  ...
                  {
                    count: data.streaks.mood,
                    icon: Smile,
                    label: "Mood",
                    color: "var(--violet)",
                    bg: "rgba(155,127,232,.1)",
                  },
                  {
                    count: data.streaks.food,
                    icon: Salad,
                    label: "Food",
                    color: "var(--green)",
                    bg: "var(--g-dim)",
