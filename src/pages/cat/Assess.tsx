      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Mock tests, adaptive exams & external tracking
          </p>
        </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold">
                  {performance?.average_score?.toFixed(0) || 0}
                </p>
        ...
        <Card className="bg-gradient-to-br from-amber-500/10 to-orange-500/10 border-amber-500/20">
          <CardContent className="pt-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold">
                  {scorePrediction?.overall_percentile?.toFixed(0) || "--"}%
                </p>
        ...
        tabs={[
          {
            value: "mocks",
            label: "Mock Tests",
            description: "Full-length & sectional",
            icon: FileQuestion,
          },
          {
            value: "adaptive",
            label: "Adaptive",
            description: "AI-powered difficulty",
            icon: Brain,
          },
          {
            value: "external",
            label: "External",
            description: "Track other platforms",
            icon: Trophy,
          },
        ]}
        value={activeTab}
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Track mocks from IMS, TIME, and other platforms
              </p>
            </div>
          ...
          {externalMocks && externalMocks.length > 0 ? (
            ...
            <Card>
              <CardContent className="py-12 text-center">
                ...
                <p className="text-muted-foreground">
                  No external mocks recorded yet.
                </p>
                <Button
...
function MockRow({ mock }: { mock: Mock }) {
  ...
  const explainMutation = useMutation({
    ...
    onError: () =>
      toast({ title: "Failed to get analysis", variant: "destructive" }),
  });
          ...
          {analysisData && (
            <div className="space-y-4 py-2">
              <div className="p-3 rounded-lg bg-violet-500/10 border border-violet-500/20">
                ...
                <p className="text-sm text-muted-foreground">
                  {analysisData.summary.practice_recommendation}
                </p>
              </div>
...
function ExternalMockRow({ mock }: { mock: ExternalMock }) {
  const platformColor =
    platformColors[mock.platform] || platformColors["Other"];
...
// Add External Mock Dialog
function AddExternalMockDialog({
  open,
  onOpenChange,
  onSuccess,
}: {
  ...
  const mutation = useMutation({
    mutationFn: () =>
      catApi.createExternalMock({
        ...
        varc_score: formData.varc_score
          ? parseFloat(formData.varc_score)
          : undefined,
        dilr_score: formData.dilr_score
          ? parseFloat(formData.dilr_score)
          : undefined,
        quant_score: formData.quant_score
          ? parseFloat(formData.quant_score)
          : undefined,
      }),
    onSuccess: () => {
    ...
    onError: () =>
      toast({ title: "Failed to add mock", variant: "destructive" }),
  });
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Record a mock from another platform
          </DialogDescription>
        </DialogHeader>
        <div className="space-y-4 py-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData((f) => ({ ...f, mock_date: e.target.value }))
                }
              />
            </div>
          </div>
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData((f) => ({ ...f, overall_score: e.target.value }))
                }
              />
            </div>
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData((f) => ({ ...f, percentile: e.target.value }))
                }
              />
            </div>
          </div>
          <div className="grid grid-cols-3 gap-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData((f) => ({ ...f, varc_score: e.target.value }))
                }
              />
            </div>
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData((f) => ({ ...f, dilr_score: e.target.value }))
                }
              />
            </div>
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData((f) => ({ ...f, quant_score: e.target.value }))
                }
              />
            </div>
          </div>
