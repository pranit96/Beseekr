    ...
    return (
      <div className="agent-card group">
        ...
        <div
          ...
          style={{
            background: `linear-gradient(90deg, ${domainColor}22, transparent)`,
            borderTopColor: `${domainColor}44`,
          }}
        />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                {templates.map((t) => (
                  ...
                  >
                    ...
                    <p className="text-[13px] font-semibold text-foreground/80 mb-1">
                      {t.name}
                    </p>
                    <p className="text-[11px] text-muted-foreground/50 line-clamp-2 leading-relaxed">
                      {t.description}
        ...
        {sorted.length > 0 ? (
          ...
          <div className="text-center py-24">
            ...
            <p className="text-sm text-muted-foreground/40 mb-6 max-w-xs mx-auto leading-relaxed">
              Create your first AI agent to start orchestrating intelligent
              conversations.
            </p>
            <button
