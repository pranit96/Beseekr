...
export default function Settings() {
  ...
  const updateMutation = useMutation({
    mutationFn: (payload: Partial<CatSettings>) =>
      catApi.updateCatSettings(payload),
    onSuccess: () => {
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <Input
              type="date"
              value={
                form.target_exam_date
                  ? format(new Date(form.target_exam_date), "yyyy-MM-dd")
                  : ""
              }
              onChange={(e) =>
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                setForm({
                  ...form,
                  target_percentile: parseInt(e.target.value),
                })
              }
              placeholder="e.g., 99"
              min="50"
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(v) =>
                setForm({ ...form, preferred_slot: v as any })
              }
            >
              <SelectTrigger>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <Input
                type="number"
                value={form.daily_study_hours_goal || ""}
                onChange={(e) =>
                  setForm({
                    ...form,
                    daily_study_hours_goal: parseInt(e.target.value),
                  })
                }
                min="1"
                max="12"
            ...
            <div>
              ...
              <Input
                type="number"
                value={form.daily_question_goal || ""}
                onChange={(e) =>
                  setForm({
                    ...form,
                    daily_question_goal: parseInt(e.target.value),
                  })
                }
                min="5"
                max="100"
          ...
          <div>
            ...
            <Input
              type="number"
              value={form.weekly_mocks_goal || ""}
              onChange={(e) =>
                setForm({
                  ...form,
                  weekly_mocks_goal: parseInt(e.target.value),
                })
              }
              min="1"
              max="7"
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <Input
              type="number"
              value={form.sectional_time_limit || 60}
              onChange={(e) =>
                setForm({
                  ...form,
                  sectional_time_limit: parseInt(e.target.value),
                })
              }
              min="30"
              max="90"
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              checked={form.enforce_sectional_timing ?? true}
              onCheckedChange={(v) =>
                setForm({ ...form, enforce_sectional_timing: v })
              }
            />
          </div>
        </CardContent>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Switch
              checked={form.email_daily_reminder ?? false}
              onCheckedChange={(v) =>
                setForm({ ...form, email_daily_reminder: v })
              }
            />
          </div>
