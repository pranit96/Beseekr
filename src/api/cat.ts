...
export async function getTasks(params?: {
  ...
  return request<PaginatedResponse<StudyTask>>(
    `/api/cat/tasks${query ? `?${query}` : ""}`,
  );
}
...
export async function getTopicFlashcards(
  topicId: string,
): Promise<Flashcard[]> {
...
export async function getMocks(params?: {
  ...
  const query = searchParams.toString();
  return request<PaginatedResponse<Mock>>(
    `/api/cat/mocks${query ? `?${query}` : ""}`,
  );
}
...
export async function updateCatSettings(
  payload: Partial<CatSettings>,
): Promise<CatSettings> {
  return request<CatSettings>("/api/cat/cat-settings", {
    method: "PUT",
...
export async function getExternalMocks(params?: {
  ...
  if (params?.limit) searchParams.set("limit", String(params.limit));
  const query = searchParams.toString();
  return request<ExternalMock[]>(
    `/api/cat/external-mocks${query ? `?${query}` : ""}`,
  );
}
...
export async function searchResources(params: {
  ...
  return request<Resource[]>(
    `/api/cat/resources/search?${searchParams.toString()}`,
  );
}
...
export async function getTopicLessons(
  ...
  return request<LessonWithProgress[]>(
    `/api/cat/learn/${encodeURIComponent(topicId)}/lessons`,
  );
}
...
export async function updateLessonProgress(
  ...
  return request<LessonWithProgress>(
    `/api/cat/learn/lessons/${lessonId}/progress`,
    {
      method: "POST",
      body: JSON.stringify(payload),
    },
...
export async function getTopicProblems(
  ...
  return request<Problem[]>(
    `/api/cat/learn/${encodeURIComponent(topicId)}/problems${query ? `?${query}` : ""}`,
  );
}

export async function getTopicRealCatProblems(
  topicName: string,
): Promise<Problem[]> {
  return request<Problem[]>(
    `/api/cat/learn/${encodeURIComponent(topicName)}/real-cat`,
  );
}
...
export async function getProblem(
  problemId: string,
  hints?: number,
): Promise<ProblemWithHints> {
  const query = hints !== undefined ? `?hints=${hints}` : "";
  return request<ProblemWithHints>(
    `/api/cat/learn/problems/${problemId}${query}`,
  );
}
...
export async function submitProblemAttempt(
  ...
  return request<ProblemAttemptResponse>(
    `/api/cat/learn/problems/${problemId}/attempt`,
    {
      method: "POST",
      body: JSON.stringify(payload),
    },
...
export async function getSessionHistory(params?: {
  ...
  return request<PaginatedResponse<LearnSession>>(
    `/api/cat/sessions/history?${searchParams}`,
  );
}
...
export async function submitLearnSessionAnswer(
  ...
  return request<ProblemAttemptResponse>(
    `/api/cat/learn/sessions/${sessionId}/answer`,
    {
      method: "POST",
      body: JSON.stringify(payload),
    },
...
export async function completeLearnSession(
  ...
  return request<LearnSession>(
    `/api/cat/learn/sessions/${sessionId}/complete`,
    {
      method: "POST",
    },
  );
...
export async function getAttemptHistory(params?: {
  ...
  if (params?.limit) searchParams.append("limit", params.limit.toString());
  return request<ProblemAttemptResponse[]>(
    `/api/cat/learn/history?${searchParams}`,
  );
}
...
export async function explainWrong(
  payload: ExplainWrongPayload,
): Promise<ExplainWrongResponse> {
...
export async function explainMock(
  payload: ExplainMockPayload,
): Promise<ExplainMockResponse> {
...
export async function submitAdaptiveAnswer(
  ...
  return request<SubmitAdaptiveAnswerResponse>(
    `/api/cat/adaptive/${examId}/submit`,
    {
      method: "POST",
      body: JSON.stringify(payload),
    },
...
export async function getAdaptiveStudyPlan(
  ...
  return request<StudyPlan>(
    `/api/cat/adaptive/study-plan?target=${targetPercentile}&weeks=${weeks}`,
  );
}
...
export async function getSectionTime(
  ...
  return request<SectionTimeResponse>(
    `/api/cat/mock/sectional/${mockId}/time?section=${section}`,
  );
}
...
export async function submitSectionalAnswer(
  ...
  return request<SectionalSubmitAnswerResponse>(
    `/api/cat/mock/sectional/${mockId}/submit`,
    {
      method: "POST",
      body: JSON.stringify(payload),
    },
...
export async function nextSection(
  ...
  return request<NextSectionResponse>(
    `/api/cat/mock/sectional/${mockId}/next-section`,
    {
      method: "POST",
    },
  );
...
export async function completeSectionalMock(
  ...
  return request<CompleteSectionalMockResponse>(
    `/api/cat/mock/sectional/${mockId}/complete`,
    {
      method: "POST",
    },
  );
...
export async function simulateCalculator(payload: {
  ...
  return request<CalculatorResponse>(
    "/api/cat/mock/sectional/calculator/simulate",
    {
      method: "POST",
      body: JSON.stringify(payload),
    },
...
export async function getAttemptAnalytics(
  ...
  return request<SectionalMockAnalytics>(
    `/api/cat/mock/sectional/analytics/${mockId}`,
  );
}

export async function getMockSummary(mockId: string): Promise<MockSummary> {
...
export async function getLeaderboard(params?: {
  ...
  return request<LeaderboardResponse>(
    `/api/cat/leaderboard${query ? `?${query}` : ""}`,
  );
}
...
export async function reportQuestion(
  ...
  return request<ReportQuestionResponse>(
    `/api/cat/questions/${questionId}/report`,
    {
      method: "POST",
      body: JSON.stringify(payload),
    },
...
export async function getAdaptiveNextQuestion(
  ...
  return request<AdaptiveNextQuestionResponse>(
    `/api/cat/adaptive/${examId}/next${query}`,
  );
}
