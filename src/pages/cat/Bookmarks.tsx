                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      <div className="flex">
                        {Array.from({
                          length: importanceConfig[bookmark.importance].stars,
                        }).map((_, i) => (
                          <Star
                            key={i}
                      ...
                      <Badge variant="secondary">
                        {importanceConfig[bookmark.importance].label}
                      </Badge>
...
function CreateCollectionDialog({
  ...
  const mutation = useMutation({
    mutationFn: () =>
      catApi.createBookmarkCollection({ name, color, icon: "📌" }),
    onSuccess: () => {
