        ...
        <Card>
          <CardContent className="pt-6 text-center">
            ...
            <p className="text-4xl font-bold text-emerald-500">
              {mockPerf?.average_score?.toFixed(0) || "-"}
            </p>
        ...
        <Card>
          <CardContent className="pt-6 text-center">
            ...
            <p className="text-4xl font-bold text-violet-500">
              {dashboard?.syllabus_progress?.overall_completion || 0}%
            </p>
              ...
              {mockPerf.trend.slice(-15).map((point, i) => (
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      height: `${(point.score / (mockPerf.best_score || 200)) * 100}%`,
                    }}
                  />
      ...
      {studyPlan && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Week of {format(new Date(studyPlan.week_start), "MMM d")} -{" "}
              {format(new Date(studyPlan.week_end), "MMM d")}
            </CardDescription>
          </CardHeader>
          <CardContent>
