      ...
      <HiredShell>
        <div className="max-w-xl mx-auto py-24 px-4 flex flex-col items-center justify-center text-center space-y-8">
          <div className="w-20 h-20 rounded-3xl bg-amber-500/10 border border-amber-500/20 flex items-center justify-center">
            <UploadCloud className="w-9 h-9 text-amber-400/70" />
          </div>
    ...
    <HiredShell>
      <div className="max-w-5xl mx-auto py-8 px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="text-center space-y-3 max-w-xl mx-auto">
          <Badge className="bg-amber-500/10 text-amber-400 border-amber-500/20 px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest shadow-[0_0_15px_rgba(245,158,11,0.2)]">
            AI Cover Letter
          </Badge>
          <h1 className="text-4xl sm:text-5xl font-bold tracking-tighter text-white">
            Cover Letter <span className="text-amber-400">Engine.</span>
          </h1>
          ...
          <div className="bg-white/[0.02] border border-white/[0.07] rounded-3xl p-6 space-y-6 self-start">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  className="bg-white/[0.03] border-white/[0.07] focus:border-amber-500/50 rounded-xl h-10 text-sm text-zinc-200"
                />
              </div>
              <div className="space-y-1.5">
                <label className="text-[10px] font-black uppercase tracking-widest text-zinc-500">
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                rows={8}
                maxLength={12000}
                className="w-full bg-white/[0.03] border border-white/[0.07] focus:border-amber-500/50 rounded-xl p-3 text-sm text-zinc-200 placeholder:text-zinc-600 outline-none resize-none font-medium leading-relaxed"
              />
            ...
            <AnimatePresence mode="wait">
              {isLoading ? (
                <motion.div
                  ...
                  animate={{ opacity: 1 }}
                  exit={{ opacity: 0 }}
                  className="min-h-[500px] bg-white/[0.02] border border-white/[0.07] rounded-3xl p-8 flex flex-col items-center justify-center gap-4 text-center"
                >
                  ...
                  <div className="flex items-center justify-between px-6 py-4 border-t border-white/[0.05] bg-white/[0.01]">
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button
                        ...
                        size="sm"
                        className="h-8 px-4 text-xs font-bold bg-amber-500/10 text-amber-400 hover:bg-amber-500/20 rounded-xl gap-1.5"
                      >
                ...
                <motion.div
                  ...
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  className="min-h-[500px] flex flex-col items-center justify-center text-center space-y-4 bg-white/[0.01] border border-dashed border-white/[0.06] rounded-3xl p-8"
                >
