...
const Landing = () => {
  ...
  const discoverFeatures = [
    {
      ...
      description:
        "Our AI analyzes thousands of Reddit, HN, and Twitter conversations to surface validated startup problems.",
      color: "bg-violet-500",
    },
    {
      icon: TrendingUp,
      ...
      description:
        "Catch rising opportunities before the competition builds it.",
      color: "bg-cyan-500",
    },
    {
      icon: DollarSign,
      ...
      description:
        "Extract willingness-to-pay signals so you know exactly what to charge.",
    ...
    },
    {
      ...
      description:
        "Know your buyer before you build. Role breakdowns, company stages, pain frequency.",
      color: "bg-orange-500",
    },
  ];
  ...
  const researchFeatures = [
    {
      ...
      description:
        "Type your idea, get TAM/SAM/SOM sizing, competitive landscape, and recommendations.",
    },
    {
      icon: Shield,
      title: "Risk Assessment",
      description:
        "Know the major risks before you invest months. We surface what could go wrong.",
    },
    {
      icon: Rocket,
      title: "Go-to-Market Strategy",
      description:
        "MVP features, distribution channels, pricing tiers - your launch playbook in seconds.",
    },
  ];
  ...
  const howItWorks = [
    {
      ...
      description:
        "Browse validated startup problems. Filter by category, sort by opportunity score.",
      icon: Search,
    },
    {
      step: "02",
      ...
      description:
        "See market validation scores, target audience insights, competitor analysis.",
      icon: FileText,
    },
    {
      step: "03",
      ...
      description:
        "Run your idea through our AI. Get pricing, GTM, and risk analysis in 60 seconds.",
      icon: Zap,
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-base sm:text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            We analyze Reddit, Hacker News, and Twitter to surface validated
            startup problems - then help you research your own ideas with market
            sizing, pricing intel, and GTM strategies.
          </p>
      ...
      <section
        id="discover"
        className="py-16 sm:py-24 px-4 sm:px-6 bg-muted/30"
      >
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto">
              Stop building solutions to problems nobody cares about. Our AI
              surfaces validated pain points from real conversations.
            </p>
          </div>
          ...
          <div className="mt-12 p-6 rounded-2xl bg-background border border-border">
            ...
            <h4 className="text-lg font-semibold mb-3">
              "Managing Revenue Share in B2B SaaS Partnerships"
            </h4>
            <div className="flex flex-wrap gap-2 mb-4">
              <span className="px-3 py-1 rounded-full bg-violet-500/10 text-violet-500 text-sm">
                SaaS
              </span>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="space-y-2 text-sm text-muted-foreground">
                <p className="flex items-start gap-2">
                  ...
                  "We track this in spreadsheets and it is a nightmare..." -
                  r/SaaS
                </p>
                <p className="flex items-start gap-2">
                  <Quote className="w-4 h-4 text-primary shrink-0 mt-0.5" />
      ...
      <section id="research" className="py-16 sm:py-24 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto">
              Have your own startup idea? Get market sizing, competitive
              analysis, pricing strategy, and a clear recommendation.
            </p>
          </div>
          ...
          <div className="p-6 rounded-2xl bg-emerald-500/5 border border-emerald-500/20">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 text-sm text-muted-foreground">
              <span className="flex items-center gap-1">
                <Clock className="w-4 h-4" /> 37s analysis
              </span>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground">
              Three simple steps to find and research your next startup
              opportunity.
            </p>
          </div>
        ...
        <div className="max-w-3xl mx-auto text-center">
          <div className="p-8 sm:p-12 rounded-3xl bg-gradient-to-br from-primary/5 to-accent/5 border border-border">
            ...
            <p className="text-muted-foreground mb-8 max-w-lg mx-auto">
              Thousands of people share their problems online every day. We turn
              those conversations into your competitive advantage.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                onClick={() => navigate("/auth")}
      ...
      <footer className="border-t border-border py-8 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm text-muted-foreground">© 2025 beseekr</p>
        </div>
      </footer>
    </div>
  );
