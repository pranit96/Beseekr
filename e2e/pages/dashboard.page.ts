...
export class DashboardPage extends BasePage {
  ...
  constructor(page: Page) {
    ...
    this.themeToggle = page.locator(
      'button[aria-label*="theme"], button[aria-label*="Toggle"]',
    );
    ...
    this.navProblems = page
      .locator('a[href="/dashboard/problems"], a:has-text("Problems")')
      .first();
    this.navWatchlist = page
      .locator('a[href="/dashboard/watchlist"], a:has-text("Watchlist")')
      .first();
    this.navSearch = page
      .locator('a[href="/dashboard/search"], a:has-text("Search")')
      .first();
    this.navFeed = page
      .locator('a[href="/dashboard/feed"], a:has-text("Feed")')
      .first();
    this.navValidate = page
      .locator('a[href="/dashboard/validate"], a:has-text("Validate")')
      .first();
    this.navPricing = page
      .locator('a[href*="/pricing"], a:has-text("Pricing")')
      .first();
    this.navAgents = page
      .locator('a[href="/dashboard/agents"], a:has-text("Agents")')
      .first();
