      ...
      <div className="max-w-6xl mx-auto space-y-10 animate-in fade-in slide-in-from-top-4 duration-500">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div>
              <h1 className="text-3xl sm:text-5xl font-black tracking-tight leading-[1.1] flex flex-col gap-1">
                <span className="text-foreground">Resume Intelligence</span>
                <span className="text-zinc-500 dark:text-zinc-400 text-lg sm:text-2xl font-bold mt-2">
              ...
              return (
                <div
                  ...
                  className={`relative p-4 rounded-2xl border transition-all duration-300 ${
                    isCompleted
                      ? "bg-indigo-500/[0.03] border-indigo-500/20 text-indigo-600 dark:text-indigo-300"
                      : isActive
                        ? "bg-zinc-100 dark:bg-white/[0.02] border-zinc-300 dark:border-white/10 text-zinc-855 dark:text-white"
                        : "bg-transparent border-zinc-200 dark:border-white/[0.04] text-zinc-400 dark:text-zinc-600"
                  }`}
                >
                    ...
                    <span
                      className={`text-[9px] font-black uppercase tracking-wider px-2 py-0.5 rounded ${
                        isCompleted
                          ...
                          : isActive
                            ? "bg-zinc-200 dark:bg-white/10 text-zinc-800 dark:text-white"
                            : "bg-zinc-100 dark:bg-white/[0.02] text-zinc-500"
                      }`}
                    >
                      Stage {s.step}
                    </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <motion.div
            ...
            className="group relative border border-zinc-200 dark:border-white/[0.07] hover:border-indigo-500/30 rounded-3xl p-6 sm:p-8 bg-zinc-50/60 dark:bg-[#0b0b12]/60 backdrop-blur-3xl shadow-2xl overflow-hidden flex flex-col justify-between min-h-[360px] text-left transition-all duration-300"
          >
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div className="w-12 h-12 rounded-2xl bg-zinc-100 dark:bg-white/[0.03] border border-zinc-200 dark:border-white/[0.08] flex items-center justify-center text-muted-foreground group-hover:text-indigo-400 group-hover:border-indigo-500/30 transition-all duration-300">
              ...
              <div className="pt-2 border-t border-zinc-200 dark:border-white/[0.04]">
                {isWorkspaceLoading ? (
                  <div className="h-20 bg-zinc-100 dark:bg-white/[0.02] rounded-xl animate-pulse" />
                ) : hasUploadDraft ? (
                  <div className="bg-zinc-100/50 dark:bg-white/[0.01] border border-zinc-200 dark:border-white/[0.04] p-4 rounded-2xl space-y-3">
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        <p className="text-xs font-black text-zinc-850 dark:text-white leading-tight">
                          {uploadDraft?.resume_data?.personal_info?.name ||
                            "Anonymous Candidate"}
                        </p>
                      ...
                      <span className="text-[10px] font-black uppercase tracking-widest text-zinc-650 dark:text-zinc-500 bg-zinc-100 dark:bg-white/[0.03] border border-zinc-200 dark:border-white/[0.07] px-2 py-0.5 rounded font-mono">
                        Active Slot
                      </span>
                    </div>

                    <div className="grid grid-cols-2 gap-3 pt-1">
                      <div className="bg-zinc-100/50 dark:bg-white/[0.02] border border-zinc-200 dark:border-white/[0.06] px-3 py-2 rounded-xl text-left">
                  ...
                  <div className="py-6 border border-dashed border-zinc-200 dark:border-white/[0.06] rounded-2xl bg-zinc-100/50 dark:bg-white/[0.01] text-center">
                    <p className="text-[11px] text-zinc-500 font-bold uppercase tracking-wider">
                      No Active Upload Draft
                    </p>
                    <p className="text-[10px] text-zinc-650 dark:text-zinc-650 font-semibold mt-0.5 max-w-[240px] mx-auto">
            ...
            {/* Actions Footer */}
            <div className="flex items-center justify-between gap-4 pt-6 border-t border-zinc-200 dark:border-white/[0.04] mt-6">
              {hasUploadDraft ? (
                <>
                  <Button
                    onClick={() => confirmPurgeWorkspace("upload")}
                    variant="ghost"
                    className="text-red-500 hover:text-red-400 hover:bg-red-500/10 font-bold h-9.5 px-3.5 rounded-xl text-xs flex items-center gap-1.5 cursor-pointer"
                  >
                    <Trash2 className="w-3.5 h-3.5" /> Wipe
                  </Button>
                  <Button
                    onClick={() => openWorkspace("upload", "edit")}
                    className="bg-zinc-950 dark:bg-white hover:bg-zinc-900 dark:hover:bg-zinc-200 text-white dark:text-black font-extrabold h-9.5 px-5 rounded-xl text-xs flex items-center gap-1 cursor-pointer transition-all shadow-md border-none"
                  >
                ...
                <Button
                  ...
                  className="w-full bg-zinc-950 dark:bg-white hover:bg-zinc-900 dark:hover:bg-zinc-200 text-white dark:text-black font-extrabold h-10 rounded-xl text-xs flex items-center justify-center gap-2 cursor-pointer shadow-md border-none"
                >
          ...
          <motion.div
            whileHover={{ y: -4 }}
            transition={{ type: "spring", stiffness: 450, damping: 28 }}
            className="group relative border border-zinc-200 dark:border-white/[0.07] hover:border-emerald-500/30 rounded-3xl p-6 sm:p-8 bg-zinc-50/60 dark:bg-[#0b0b12]/60 backdrop-blur-3xl shadow-2xl overflow-hidden flex flex-col justify-between min-h-[360px] text-left transition-all duration-300"
          >
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div className="w-12 h-12 rounded-2xl bg-zinc-100 dark:bg-white/[0.03] border border-zinc-200 dark:border-white/[0.08] flex items-center justify-center text-muted-foreground group-hover:text-emerald-400 group-hover:border-emerald-500/30 transition-all duration-300">
              ...
              <div className="pt-2 border-t border-zinc-200 dark:border-white/[0.04]">
                {isWorkspaceLoading ? (
                  ...
                  <div className="py-6 border border-dashed border-zinc-200 dark:border-white/[0.06] rounded-2xl bg-zinc-100/50 dark:bg-white/[0.01] text-center">
                    ...
                    <p className="text-[10px] text-zinc-650 dark:text-zinc-655 font-semibold mt-0.5 max-w-[240px] mx-auto">
        ...
        <div className="space-y-6 pt-4 border-t border-zinc-200 dark:border-white/[0.04] text-left">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 pb-2">
            <div className="flex items-center gap-3">
              <div className="p-2.5 bg-zinc-100 dark:bg-white/[0.02] border border-zinc-200 dark:border-white/[0.06] rounded-xl">
            ...
            <div className="flex bg-zinc-100 dark:bg-background border border-zinc-200 dark:border-white/[0.05] p-1 rounded-2xl shrink-0 self-start sm:self-center shadow-2xl">
              <button
                ...
                className={`px-4 sm:px-5 py-2 text-[11px] sm:text-xs font-bold rounded-xl transition-all duration-300 flex items-center gap-2 cursor-pointer ${
                  workspaceMode === "template"
                    ? "bg-white dark:bg-zinc-800 text-zinc-900 dark:text-white shadow-lg scale-[1.02]"
                    : "text-muted-foreground hover:text-zinc-800 dark:hover:text-zinc-200 hover:bg-zinc-200/50 dark:hover:bg-white/[0.02]"
                }`}
              >
          ...
          {isGlobalLoading ? (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[1, 2, 3].map((n) => (
                <div
                  key={n}
                  className="h-[140px] rounded-2xl bg-zinc-100 dark:bg-white/[0.02] border border-zinc-200 dark:border-white/[0.06] animate-pulse"
                />
              ))}
            </div>
          ) : revisionHistory.length === 0 ? (
            <div className="text-center py-14 border border-dashed border-zinc-200 dark:border-white/[0.08] rounded-2xl bg-zinc-50/50 dark:bg-white/[0.01] backdrop-blur-sm">
              <div className="w-10 h-10 bg-zinc-100 dark:bg-white/[0.03] border border-zinc-200 dark:border-white/[0.08] rounded-xl mx-auto flex items-center justify-center mb-4 text-zinc-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {revisionHistory.map((rev) => (
                <motion.div
                  ...
                  key={rev.id}
                  className="group border border-zinc-200 dark:border-white/[0.06] hover:border-zinc-350 dark:hover:border-white/[0.12] bg-zinc-50/50 dark:bg-white/[0.01] hover:bg-zinc-100/50 dark:hover:bg-white/[0.02] p-5 rounded-2xl transition-all duration-300 relative flex flex-col justify-between gap-4 min-h-[140px] overflow-hidden"
                >
                  ...
                  <div className="space-y-2.5 text-left pr-6">
                    ...
                    <h4 className="font-bold text-zinc-800 dark:text-zinc-200 line-clamp-1 text-sm group-hover:text-zinc-950 dark:group-hover:text-white transition-colors tracking-tight">
                      {rev.name}
                    </h4>
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-zinc-200 dark:border-white/[0.04] mt-1 select-none">
                    ...
                    <Button
                      ...
                      size="sm"
                      className="bg-zinc-100 dark:bg-white/[0.03] border border-zinc-200 dark:border-white/[0.08] hover:bg-zinc-950 dark:hover:bg-white hover:text-white dark:hover:text-black hover:border-transparent text-muted-foreground font-bold h-7.5 px-3 rounded-lg text-[11px] gap-1 shadow-sm transition-all duration-200 cursor-pointer"
                    >
      ...
      <AlertDialog open={isPurgeDialogOpen} onOpenChange={setIsPurgeDialogOpen}>
        <AlertDialogContent className="bg-background border border-zinc-200 dark:border-white/[0.08] rounded-3xl max-w-md p-6 shadow-2xl animate-in fade-in zoom-in-95 duration-200">
          <AlertDialogHeader className="space-y-3">
            ...
            <AlertDialogTitle className="text-xl font-bold tracking-tight text-foreground text-left">
          ...
          <AlertDialogFooter className="mt-6 gap-3 flex flex-col sm:flex-row sm:justify-end">
            <AlertDialogCancel className="bg-transparent border border-zinc-200 dark:border-white/[0.08] text-muted-foreground hover:bg-zinc-100 dark:hover:bg-white/[0.03] hover:text-zinc-900 dark:hover:text-white rounded-xl font-bold text-xs px-5 py-2 h-10 transition-all cursor-pointer">
              Cancel
            </AlertDialogCancel>
            <AlertDialogAction
