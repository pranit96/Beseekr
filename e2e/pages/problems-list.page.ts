...
export class ProblemsListPage extends BasePage {
  ...
  constructor(page: Page) {
    ...
    // Problem cards
    this.problemCards = page
      .locator('[data-testid="problem-card"], article, [class*="Card"]')
      .filter({ has: page.locator("h3, h4") });
    this.problemTitles = page.locator('[data-testid="problem-title"], h3, h4');
    this.problemScores = page.locator(
      '[data-testid="score"], [class*="score"]',
    );
    this.problemCategories = page.locator(
      '[data-testid="category"], [class*="Badge"]',
    );
