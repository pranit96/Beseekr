                      ...
                      <div className="flex flex-wrap justify-center gap-2 max-w-lg">
                        {[
                          ...
                          <motion.button
                            ...
                            className="flex items-center gap-1.5 rounded-full border border-white/8 bg-white/[0.03] px-4 py-2 text-xs text-muted-foreground hover:text-white hover:border-violet-500/30 hover:bg-violet-500/5 transition-all duration-200"
                          >
                        ...
                        {messages.map((msg, i) => (
                          ...
                          >
                            ...
                            <div className="max-w-[75%] flex flex-col gap-2">
                              <div
                                className={`rounded-2xl px-4 py-3 text-sm leading-relaxed ${msg.role === "user" ? "bg-violet-600 text-white rounded-br-md shadow-lg shadow-violet-500/20" : "bg-white/[0.04] border border-white/[0.06] text-foreground rounded-bl-md"}`}
                              >
                                {msg.content}
                              </div>
                    ...
                    <div className="flex items-center gap-3 bg-white/[0.04] border border-white/[0.08] rounded-2xl px-4 py-3 focus-within:border-violet-500/40 transition-colors">
                      ...
                      {question.trim() && (
                        <motion.button
                          ...
                          type="submit"
                          disabled={isQuerying}
                          className="h-8 w-8 rounded-xl bg-violet-600 hover:bg-violet-500 flex items-center justify-center text-white transition-colors disabled:opacity-50 shrink-0"
                        >
                  ...
                  <div className="flex items-center gap-2">
                    <div className="flex items-center gap-2 bg-white/[0.04] border border-white/[0.06] rounded-xl px-3 py-2">
                      ...
                      <input
                        ...
                        className="bg-transparent text-xs text-foreground focus:outline-none placeholder:text-muted-foreground/60 w-40"
                      />
                    </div>
                    <Button
                      size="sm"
                  ...
                  {isLoadingItems ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-20 text-center">
                      <motion.div
                        animate={{ y: [0, -6, 0] }}
                        transition={{ duration: 3, repeat: Infinity }}
                        className="h-14 w-14 rounded-2xl bg-white/[0.03] border border-white/[0.06] flex items-center justify-center mb-4"
                      >
                      ...
                      {!searchQuery && (
                        <Button
                          onClick={() => setShowAddPanel(true)}
                          size="sm"
                          className="mt-4 bg-violet-600 hover:bg-violet-500 text-white rounded-xl gap-1.5 text-xs"
                        >
                      ...
                      <AnimatePresence>
                        {filteredItems.map((item: any, i: number) => (
                          <motion.div
                            ...
                            className="group flex items-center gap-4 rounded-2xl border border-white/[0.05] bg-white/[0.02] px-4 py-4 hover:bg-white/[0.04] hover:border-white/[0.08] transition-all duration-200"
                          >
                            ...
                            <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                              {item.source_url && (
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="h-8 w-8 rounded-lg flex items-center justify-center text-muted-foreground hover:text-white hover:bg-white/[0.06] transition-colors"
                                >
                ...
                {(isLoadingMap || isFetchingMap) && (
                  <div className="absolute inset-0 z-20 flex flex-col items-center justify-center bg-[#090b12]/80 backdrop-blur-sm">
                    <motion.div
                      ...
                      className="h-16 w-16 rounded-2xl bg-violet-500/15 border border-violet-500/25 flex items-center justify-center mb-4"
                    >
                  ...
                  {isLoadingInsights || isFetchingInsights ? (
                    <div className="flex flex-col items-center justify-center py-20">
                      <motion.div
                        ...
                        className="h-14 w-14 rounded-2xl bg-violet-500/15 border border-violet-500/25 flex items-center justify-center mb-4"
                      >
                    ...
                    <div className="space-y-5">
                      ...
                      <motion.div
                        ...
                        className="relative rounded-2xl border border-violet-500/20 bg-violet-500/[0.04] p-6 overflow-hidden"
                      >
                        <div className="absolute top-0 right-0 opacity-[0.04] pointer-events-none">
                          <BrainIcon className="h-40 w-40 text-violet-400" />
                        </div>
                            ...
                            {insightsData.themes.map(
                              (theme: string, i: number) => (
                                <motion.span
                                  ...
                                  className="px-4 py-2 rounded-full border border-white/[0.08] bg-white/[0.03] text-sm font-semibold text-white hover:border-violet-500/30 hover:bg-violet-500/5 transition-all cursor-default"
                                >
                                  {theme}
                                </motion.span>
                              ),
            ...
            >
              <div className="w-full max-w-lg bg-[#0f1120] border border-white/[0.08] rounded-3xl shadow-2xl shadow-black/50 overflow-hidden">
                <div className="flex items-center justify-between px-6 py-5 border-b border-white/[0.06]">
                  ...
                  <button
                    onClick={() => setShowAddPanel(false)}
                    className="h-8 w-8 rounded-xl flex items-center justify-center text-muted-foreground hover:text-white hover:bg-white/[0.06] transition-colors"
                  >
                    <X className="h-4 w-4" />
                  </button>
                </div>
                  ...
                  <div className="flex gap-1 bg-white/[0.03] border border-white/[0.05] rounded-2xl p-1">
                    {[
                      ...
                      <button
                        ...
                        className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl text-xs font-bold transition-all duration-200 ${saveTab === t.id ? "bg-violet-600/25 text-violet-300 border border-violet-500/30" : "text-muted-foreground hover:text-white"}`}
                      >
                        {t.icon} {t.label}
                      </button>
                    ))}
                ...
                <div className="px-6 py-5 space-y-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-white/[0.04] border border-white/[0.08] rounded-xl px-4 py-2.5 text-sm text-white placeholder:text-muted-foreground/50 focus:outline-none focus:border-violet-500/50 transition-colors"
                    />
                  </div>

                  <div>
                    <label className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider block mb-1.5">
                      {saveTab === "url" ? "URL" : "Content"}
                    </label>
                    <AnimatePresence mode="wait">
                      {saveTab === "url" ? (
                        <motion.div
